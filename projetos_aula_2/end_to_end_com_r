...
Execute este código inteiro em seu RStudio, pois ao gerar um link para seu DataApp os servidores da Google não lhe darão acesso. 
Realize em sua própria máquina. Documentação da lógica fuzzy em R https://cran.r-project.org/web/packages/FuzzyR/FuzzyR.pdf
'''
